...
/**
 * Controller for the NYOrdering View.
 * Handles pizza options, including type and size.
 * @author Rishabh Patel, Albert Zou
 */
public class NYOrderingController extends SecondaryViewController implements Initializable {
    ...
    private static final String NYD_IMAGE = "nyDeluxe.jpg";
    private static final String NYBBQ_IMAGE = "nyBBQ.jpg";
    private static final String NYM_IMAGE = "nyMeatzza.jpg";
    private static final String NYBYO_IMAGE = "nyBYO.png";

    /**
     * Constructs NYOrderingController object.
     * Creates new NYPizza factory object.
     */
    public NYOrderingController() {
        factory = new NYPizza();
    }
