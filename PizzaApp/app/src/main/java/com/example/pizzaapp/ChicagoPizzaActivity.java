...
/**
 * Activity for the ChicagoPizza ordering screen.
 * Handles pizza options, including type and size.
 * @author Rishabh Patel, Albert Zou
 */
public class ChicagoPizzaActivity extends SecondaryViewActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.chicago_byo);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                order.add(pizza);
                makePopUp(getString(R.string.pizza_title), getString(R.string.pizza_msg));
            }
        });
    }
    ...
    /**
     * Sets image and toppings settings vased on the chosen type of pizza.
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        switch ( i ) {
            ...
            case DELUXE:
                ...
                refresh();
                image.setImageResource(R.drawable.chicago_deluxe);
                for ( Topping t : DELUXE_TOP ) selectTopping(t);
                break;
            case BBQ:
                pizza = factory.createBBQChicken();
                refresh();
                image.setImageResource(R.drawable.chicago_bbq);
                for ( Topping t : BBQ_CHICKEN_TOP ) selectTopping(t);
                break;
            case MEATZZA:
                pizza = factory.createMeatzza();
                refresh();
                image.setImageResource(R.drawable.chicago_meatzza);
    ...
    /**
     * Handles the selected item becoming unavailable.
     * @param adapterView default parameter
     */
    @Override
